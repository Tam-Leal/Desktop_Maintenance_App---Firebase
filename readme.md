...
````
**Note: To configure the app admin, change theauth.token.email == 'admin@mycompany.com' from read and write to the email that will be the admin created in ```Authentication```**
